...
#define MOVEMENT_ACTION_EMOTE_HAPPY                     0xAE
#define MOVEMENT_ACTION_EMOTE_UPSET                     0xAF
//fast diagonal movement
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_UP_LEFT      0xB0
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_UP_RIGHT     0xB1
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_DOWN_LEFT    0xB2
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_DOWN_RIGHT   0xB3
#define MOVEMENT_ACTION_SPY_VANISH                      0xB4
#define MOVEMENT_ACTION_SHAKE_HORIZONTAL                0xB5
#define MOVEMENT_ACTION_SHAKE_VERTICAL                  0xB6
#define MOVEMENT_ACTION_VEYLOR_SPECIAL                  0xB7
...
#define ANIM_SPY_VANISH (ANIM_STD_COUNT + 0)
#define ANIM_VEYLOR_SPECIAL (ANIM_STD_COUNT + 1)
