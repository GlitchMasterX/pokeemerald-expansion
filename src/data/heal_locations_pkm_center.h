...
static const struct HealLocation sHealLocationsPokemonCenter[NUM_HEAL_LOCATIONS - 1] =
{
    ...
    {
        .mapGroup = MAP_GROUP(MAP_ACADEMY_VIEW),
        .mapNum = MAP_NUM(MAP_ACADEMY_VIEW),
        .x = 2,
        .y = 7,
    },
    ...
    {
        .mapGroup = MAP_GROUP(MAP_ASTRALIS_ACADEMY_POKEMON_CENTER),
        .mapNum = MAP_NUM(MAP_ASTRALIS_ACADEMY_POKEMON_CENTER),
    ...
    [HEAL_LOCATION_LUXURA_VEILWOOD - 1] =
    {
        .mapGroup = MAP_GROUP(MAP_ASTRALIS_ACADEMY_POKEMON_CENTER),
        .mapNum = MAP_NUM(MAP_ASTRALIS_ACADEMY_POKEMON_CENTER),
        DEFAULT_POKEMON_CENTER_COORDS,
    },
    [HEAL_LOCATION_LUXURA_ISLAND - 1] =
    {
        .mapGroup = MAP_GROUP(MAP_ASTRALIS_ACADEMY_POKEMON_CENTER),
        .mapNum = MAP_NUM(MAP_ASTRALIS_ACADEMY_POKEMON_CENTER),
        DEFAULT_POKEMON_CENTER_COORDS,
...
static const u8 sHealNpcLocalId[NUM_HEAL_LOCATIONS - 1] =
{
    ...
    [HEAL_LOCATION_LUXURA_VEILWOOD - 1] = 1,
    [HEAL_LOCATION_LUXURA_ISLAND - 1] = 1,
