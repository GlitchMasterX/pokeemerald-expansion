...
enum ScrOp
{
    ...
    SCR_OP_WARPCONTINUESCRIPT = 0xE5,
    SCR_OP_TOGGLEOUTFIT = 0xE6,
    SCR_OP_GETOUTFITSTATUS = 0xE7,
    SCR_OP_BUFFEROUTFITSTR = 0xE8,
    SCR_OP_POKEMARTOUTFIT = 0xE9,
    SCR_OP_COPYMETATILEEX = 0xEA,
    SCR_OP_HIDEFOLLOWER = 0xEB,
    SCR_OP_WEAROUTFIT = 0xEC,
};
