...
{
    {MAPSEC_UNDERWATER_105,             MAPSEC_DUSKHOLLOW_VILLAGE},
    {MAPSEC_UNDERWATER_124,             MAPSEC_HIGHPEAK_MONESTERY},
    #ifdef BUGFIX
    {MAPSEC_UNDERWATER_125,             MAPSEC_EMBERWATCH_FORT},
    #else
    ...
    #endif
    {MAPSEC_UNDERWATER_126,             MAPSEC_STARFALL_PLAINS},
    {MAPSEC_UNDERWATER_127,             MAPSEC_FORGOTTEN_WOODS},
    {MAPSEC_UNDERWATER_128,             MAPSEC_ROUTE_128},
    {MAPSEC_UNDERWATER_129,             MAPSEC_ROUTE_129},
    {MAPSEC_UNDERWATER_SOOTOPOLIS,      MAPSEC_CINDERBROOK_TOWN},
    {MAPSEC_UNDERWATER_SEAFLOOR_CAVERN, MAPSEC_ROUTE_128},
    {MAPSEC_AQUA_HIDEOUT,               MAPSEC_NOCTURNE_CITY},
    {MAPSEC_AQUA_HIDEOUT_OLD,           MAPSEC_NOCTURNE_CITY},
    {MAPSEC_MAGMA_HIDEOUT,              MAPSEC_ABYSSAL_TRENCH},
    {MAPSEC_UNDERWATER_SEALED_CHAMBER,  MAPSEC_ROUTE_134},
    {MAPSEC_PETALBURG_WOODS,            MAPSEC_MYSTRAL_TOWN},
    {MAPSEC_JAGGED_PASS,                MAPSEC_ABYSSAL_TRENCH},
    {MAPSEC_MT_PYRE,                    MAPSEC_SILVERPINE_VILLAGE},
    {MAPSEC_SKY_PILLAR,                 MAPSEC_ROUTE_131},
    {MAPSEC_MIRAGE_TOWER,               MAPSEC_FROSTVEIL_PEAK},
    {MAPSEC_SERVANTQUARTER,               MAPSEC_FROSTVEIL_PEAK},
    {MAPSEC_DESERT_UNDERPASS,           MAPSEC_POINT_ALPHA},
    {MAPSEC_ALTERING_CAVE,              MAPSEC_THORNVALE_VILLAGE},
    {MAPSEC_ARTISAN_CAVE,               MAPSEC_THORNVALE_VILLAGE},
    {MAPSEC_ABANDONED_SHIP,             MAPSEC_SHAYMIN_VILLAGE},
...
{
    [ABNORMAL_WEATHER_ROUTE_114_NORTH - 1] = MAPSEC_POINT_ALPHA,
    [ABNORMAL_WEATHER_ROUTE_114_SOUTH - 1] = MAPSEC_POINT_ALPHA,
    [ABNORMAL_WEATHER_ROUTE_115_WEST  - 1] = MAPSEC_POINT_BETA,
    [ABNORMAL_WEATHER_ROUTE_115_EAST  - 1] = MAPSEC_POINT_BETA,
    [ABNORMAL_WEATHER_ROUTE_116_NORTH - 1] = MAPSEC_POINT_GAMMA,
    [ABNORMAL_WEATHER_ROUTE_116_SOUTH - 1] = MAPSEC_POINT_GAMMA,
    [ABNORMAL_WEATHER_ROUTE_118_EAST  - 1] = MAPSEC_POINT_EPSILON,
    [ABNORMAL_WEATHER_ROUTE_118_WEST  - 1] = MAPSEC_POINT_EPSILON,
    [ABNORMAL_WEATHER_ROUTE_105_NORTH - 1] = MAPSEC_DUSKHOLLOW_VILLAGE,
    [ABNORMAL_WEATHER_ROUTE_105_SOUTH - 1] = MAPSEC_DUSKHOLLOW_VILLAGE,
    [ABNORMAL_WEATHER_ROUTE_125_WEST  - 1] = MAPSEC_EMBERWATCH_FORT,
    [ABNORMAL_WEATHER_ROUTE_125_EAST  - 1] = MAPSEC_EMBERWATCH_FORT,
    [ABNORMAL_WEATHER_ROUTE_127_NORTH - 1] = MAPSEC_FORGOTTEN_WOODS,
    [ABNORMAL_WEATHER_ROUTE_127_SOUTH - 1] = MAPSEC_FORGOTTEN_WOODS,
...
{
    [MAPSEC_LUXURA_ISLAND] = {MAP_GROUP(MAP_LITTLEROOT_TOWN), MAP_NUM(MAP_LITTLEROOT_TOWN), HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE_2F},
    [MAPSEC_LUXURA_MANSION] = {MAP_GROUP(MAP_OLDALE_TOWN), MAP_NUM(MAP_OLDALE_TOWN), HEAL_LOCATION_OLDALE_TOWN},
    [MAPSEC_IRONHEARTH_CITY] = {MAP_GROUP(MAP_DEWFORD_TOWN), MAP_NUM(MAP_DEWFORD_TOWN), HEAL_LOCATION_DEWFORD_TOWN},
    [MAPSEC_LUXURA_VEILWOOD] = {MAP_GROUP(MAP_LAVARIDGE_TOWN), MAP_NUM(MAP_LAVARIDGE_TOWN), HEAL_LOCATION_LAVARIDGE_TOWN},
    [MAPSEC_MT_CINDER] = {MAP_GROUP(MAP_FALLARBOR_TOWN), MAP_NUM(MAP_FALLARBOR_TOWN), HEAL_LOCATION_FALLARBOR_TOWN},
    [MAPSEC_LUMINAE_CITY] = {MAP_GROUP(MAP_GRANITE_CAVE_1F), MAP_NUM(MAP_GRANITE_CAVE_1F), HEAL_LOCATION_LUXURA_VEILWOOD},
    [MAPSEC_VERDANTIA_TOWN] = {MAP_GROUP(MAP_LUXURA_ISLAND), MAP_NUM(MAP_LUXURA_ISLAND), HEAL_LOCATION_LUXURA_ISLAND},
    [MAPSEC_ASTRALIS_ACADEMY] = {MAP_GROUP(MAP_ASTRALIS_ACADEMY), MAP_NUM(MAP_ASTRALIS_ACADEMY), HEAL_LOCATION_PETALBURG_CITY},
    [MAPSEC_VOLTHAVEN_CITY] = {MAP_GROUP(MAP_SLATEPORT_CITY), MAP_NUM(MAP_SLATEPORT_CITY), HEAL_LOCATION_SLATEPORT_CITY},
    [MAPSEC_SHIMMER_CITY] = {MAP_GROUP(MAP_MAUVILLE_CITY), MAP_NUM(MAP_MAUVILLE_CITY), HEAL_LOCATION_MAUVILLE_CITY},
    [MAPSEC_EMBERVALE_CITY] = {MAP_GROUP(MAP_RUSTBORO_CITY), MAP_NUM(MAP_RUSTBORO_CITY), HEAL_LOCATION_RUSTBORO_CITY},
    [MAPSEC_ASTRAVEIL_CITY] = {MAP_GROUP(MAP_ASTRAVEIL_CITY), MAP_NUM(MAP_ASTRAVEIL_CITY), HEAL_LOCATION_FORTREE_CITY},
    [MAPSEC_NOCTURNE_CITY] = {MAP_GROUP(MAP_LILYCOVE_CITY), MAP_NUM(MAP_LILYCOVE_CITY), HEAL_LOCATION_LILYCOVE_CITY},
    [MAPSEC_WILLOWMERE_VILLAGE] = {MAP_GROUP(MAP_MOSSDEEP_CITY), MAP_NUM(MAP_MOSSDEEP_CITY), HEAL_LOCATION_MOSSDEEP_CITY},
    [MAPSEC_CINDERBROOK_TOWN] = {MAP_GROUP(MAP_SOOTOPOLIS_CITY), MAP_NUM(MAP_SOOTOPOLIS_CITY), HEAL_LOCATION_SOOTOPOLIS_CITY},
    [MAPSEC_FROSTPEAK_VILLAGE] = {MAP_GROUP(MAP_EVER_GRANDE_CITY), MAP_NUM(MAP_EVER_GRANDE_CITY), HEAL_LOCATION_EVER_GRANDE_CITY},
    [MAPSEC_LUNAR_GROVE] = {MAP_GROUP(MAP_ROUTE101), MAP_NUM(MAP_ROUTE101), HEAL_LOCATION_NONE},
    [MAPSEC_ASHVEIL_TOWN] = {MAP_GROUP(MAP_ROUTE102), MAP_NUM(MAP_ROUTE102), HEAL_LOCATION_NONE},
    [MAPSEC_THORNVALE_VILLAGE] = {MAP_GROUP(MAP_ROUTE103), MAP_NUM(MAP_ROUTE103), HEAL_LOCATION_NONE},
    [MAPSEC_MYSTRAL_TOWN] = {MAP_GROUP(MAP_ROUTE104), MAP_NUM(MAP_ROUTE104), HEAL_LOCATION_NONE},
    [MAPSEC_DUSKHOLLOW_VILLAGE] = {MAP_GROUP(MAP_ROUTE105), MAP_NUM(MAP_ROUTE105), HEAL_LOCATION_NONE},
    [MAPSEC_SEASIDE_HAVEN] = {MAP_GROUP(MAP_ROUTE106), MAP_NUM(MAP_ROUTE106), HEAL_LOCATION_NONE},
    [MAPSEC_WHISPERING_WOODS] = {MAP_GROUP(MAP_ROUTE107), MAP_NUM(MAP_ROUTE107), HEAL_LOCATION_NONE},
    [MAPSEC_SHAYMIN_VILLAGE] = {MAP_GROUP(MAP_ROUTE108), MAP_NUM(MAP_ROUTE108), HEAL_LOCATION_NONE},
    [MAPSEC_CRYSTALLINE_CAVERNS] = {MAP_GROUP(MAP_ROUTE109), MAP_NUM(MAP_ROUTE109), HEAL_LOCATION_NONE},
    [MAPSEC_SCORCHED_WASTES] = {MAP_GROUP(MAP_ROUTE110), MAP_NUM(MAP_ROUTE110), HEAL_LOCATION_NONE},
    [MAPSEC_FROSTVEIL_PEAK] = {MAP_GROUP(MAP_ROUTE111), MAP_NUM(MAP_ROUTE111), HEAL_LOCATION_NONE},
    [MAPSEC_ABYSSAL_TRENCH] = {MAP_GROUP(MAP_ROUTE112), MAP_NUM(MAP_ROUTE112), HEAL_LOCATION_NONE},
    [MAPSEC_NETHERVEIL_CITY] = {MAP_GROUP(MAP_ROUTE113), MAP_NUM(MAP_ROUTE113), HEAL_LOCATION_NONE},
    [MAPSEC_POINT_ALPHA] = {MAP_GROUP(MAP_ROUTE114), MAP_NUM(MAP_ROUTE114), HEAL_LOCATION_NONE},
    [MAPSEC_POINT_BETA] = {MAP_GROUP(MAP_ROUTE115), MAP_NUM(MAP_ROUTE115), HEAL_LOCATION_NONE},
    [MAPSEC_POINT_GAMMA] = {MAP_GROUP(MAP_ROUTE116), MAP_NUM(MAP_ROUTE116), HEAL_LOCATION_NONE},
    [MAPSEC_POINT_DELTA] = {MAP_GROUP(MAP_ROUTE117), MAP_NUM(MAP_ROUTE117), HEAL_LOCATION_NONE},
    [MAPSEC_POINT_EPSILON] = {MAP_GROUP(MAP_ROUTE118), MAP_NUM(MAP_ROUTE118), HEAL_LOCATION_NONE},
    [MAPSEC_LAKE_SERENITY] = {MAP_GROUP(MAP_ROUTE119), MAP_NUM(MAP_ROUTE119), HEAL_LOCATION_NONE},
    [MAPSEC_REDEMPTION_ISLE] = {MAP_GROUP(MAP_ROUTE120), MAP_NUM(MAP_ROUTE120), HEAL_LOCATION_NONE},
    [MAPSEC_ROYAL_CAPITAL] = {MAP_GROUP(MAP_ROUTE121), MAP_NUM(MAP_ROUTE121), HEAL_LOCATION_NONE},
    [MAPSEC_SILVERPINE_VILLAGE] = {MAP_GROUP(MAP_ROUTE122), MAP_NUM(MAP_ROUTE122), HEAL_LOCATION_NONE},
    [MAPSEC_CRYSTALSHORE_TOWN] = {MAP_GROUP(MAP_ROUTE123), MAP_NUM(MAP_ROUTE123), HEAL_LOCATION_NONE},
    [MAPSEC_HIGHPEAK_MONESTERY] = {MAP_GROUP(MAP_ROUTE124), MAP_NUM(MAP_ROUTE124), HEAL_LOCATION_NONE},
    [MAPSEC_EMBERWATCH_FORT] = {MAP_GROUP(MAP_ROUTE125), MAP_NUM(MAP_ROUTE125), HEAL_LOCATION_NONE},
    [MAPSEC_STARFALL_PLAINS] = {MAP_GROUP(MAP_ROUTE126), MAP_NUM(MAP_ROUTE126), HEAL_LOCATION_NONE},
    [MAPSEC_FORGOTTEN_WOODS] = {MAP_GROUP(MAP_ROUTE127), MAP_NUM(MAP_ROUTE127), HEAL_LOCATION_NONE},
...
{
    {
        ...
        .mapSecId = MAPSEC_FROSTPEAK_VILLAGE,
...
static void InitMapBasedOnPlayerLocation(void)
{
    ...
    {
    case MAPSEC_POINT_ALPHA:
        if (y != 0)
            x = 0;
        break;
    case MAPSEC_STARFALL_PLAINS:
...
static void RegionMap_InitializeStateBasedOnSSTidalLocation(void)
{
    ...
    case SS_TIDAL_LOCATION_SLATEPORT:
        sRegionMap->mapSecId = MAPSEC_VOLTHAVEN_CITY;
        break;
    case SS_TIDAL_LOCATION_LILYCOVE:
        sRegionMap->mapSecId = MAPSEC_NOCTURNE_CITY;
        break;
    case SS_TIDAL_LOCATION_ROUTE124:
        sRegionMap->mapSecId = MAPSEC_HIGHPEAK_MONESTERY;
        break;
...
static void CreateFlyDestIcons(void)
{
    ...
    for (mapSecId = MAPSEC_LUXURA_ISLAND; mapSecId <= MAPSEC_FROSTPEAK_VILLAGE; mapSecId++)
    {
