...
const u32 gTrainerFrontPic_Alistair[] = INCBIN_U32("graphics/trainers/front_pics/alistair.4bpp.smol");
const u16 gTrainerPalette_Alistair[] = INCBIN_U16("graphics/trainers/front_pics/alistair.gbapal");

const u32 gTrainerFrontPic_Fiona[] = INCBIN_U32("graphics/trainers/front_pics/fiona.4bpp.smol");
const u16 gTrainerPalette_Fiona[] = INCBIN_U16("graphics/trainers/front_pics/fiona.gbapal");

const u32 gTrainerFrontPic_Voss[] = INCBIN_U32("graphics/trainers/front_pics/voss.4bpp.smol");
const u16 gTrainerPalette_Voss[] = INCBIN_U16("graphics/trainers/front_pics/voss.gbapal");
...
const u32 gTrainerFrontPic_Spy[] = INCBIN_U32("graphics/trainers/front_pics/spy.4bpp.smol");
const u16 gTrainerPalette_Spy[] = INCBIN_U16("graphics/trainers/front_pics/spy.gbapal");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_FRONT_SELENE, gTrainerFrontPic_PikeQueenLucy, gTrainerPalette_PikeQueenLucy),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_SILAS, gTrainerFrontPic_Silas, gTrainerPalette_Silas),
    ...
    TRAINER_SPRITE(TRAINER_PIC_FRONT_EQUINO_ADMIN, gTrainerFrontPic_SparkAdmin, gTrainerPalette_SparkAdmin),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_EQUINO_LEADER, gTrainerFrontPic_SparkLeader, gTrainerPalette_SparkLeader),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_S_EQUINO_GRUNT_M, gTrainerFrontPic_SparkGruntM, gTrainerPalette_SparkGruntM),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_S_EQUINO_GRUNT_F, gTrainerFrontPic_SparkGruntF, gTrainerPalette_SparkGruntF),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_SPY, gTrainerFrontPic_Spy, gTrainerPalette_Spy),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_SURGE, gTrainerFrontPic_Surge, gTrainerPalette_Surge),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_ALISTAIR, gTrainerFrontPic_Alistair, gTrainerPalette_Alistair),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_XYLAR, gTrainerFrontPic_Xylar, gTrainerPalette_Xylar),
