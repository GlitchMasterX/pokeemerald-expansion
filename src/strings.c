...
const u8 gText_ThisIsAPokemon[] = _("{COLOR BLUE}{SHADOW LIGHT_GRAY}And this mischievous little\nPokémon floating beside me?{PAUSE 96}\p");
...
const u8 gText_DefaultMaleName[] = _("Xylar");
const u8 gText_DefaultFemaleName[] = _("PEDRITA");
...
const u8 gText_HealthboxNickname[] = _("{BACKGROUND TRANSPARENT}{ACCENT TRANSPARENT}");
...
ALIGNED(4) const u8 gText_EndedWithXUnitsPowder[] = _("{PAUSE_MUSIC}{PLAY_BGM MUS_DP_LEVEL_UP}You ended up with {STR_VAR_1} units of\nsilky-smooth BERRY POWDER.{RESUME_MUSIC}\pYour total amount of BERRY POWDER\nis {STR_VAR_2}.\p");
...
const u8 gText_InstantText[] = _("INSTANT TEXT");
...
const u8 gText_QuickRun[] = _("QUICK RUN");
...
const u8 gText_DexHoenn[] = _("Velanthis");
...
const u8 gText_Hoenn[] = _("Velanthis");
