...
enum __attribute__((packed)) TrainerPicID
{
    ...
    TRAINER_PIC_FRONT_SELENE,
    TRAINER_PIC_FRONT_SILAS,
    TRAINER_PIC_FRONT_RED,
    TRAINER_PIC_FRONT_LEAF,
    TRAINER_PIC_FRONT_RS_BRENDAN,
    TRAINER_PIC_FRONT_RS_MAY,
    TRAINER_PIC_FRONT_S_EQUINO_GRUNT_F,
    TRAINER_PIC_FRONT_S_EQUINO_GRUNT_M,         
    TRAINER_PIC_FRONT_EQUINO_LEADER,          
    TRAINER_PIC_FRONT_EQUINO_ADMIN,           
    TRAINER_PIC_FRONT_SPY,                   
    TRAINER_PIC_FRONT_SURGE,                 
    TRAINER_PIC_FRONT_ALISTAIR,              
    TRAINER_PIC_FRONT_FIONA,                 
