...
static const u32 sTitleScreenRayquazaGfx[] = INCBIN_U32("graphics/title_screen/mewtwo.4bpp.smol");
static const u32 sTitleScreenRayquazaTilemap[] = INCBIN_U32("graphics/title_screen/mewtwo.bin.smolTM");
