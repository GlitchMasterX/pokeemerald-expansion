...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_TEMPEST_SPARK] = { _("TEMPEST") },
    [TRAINER_CLASS_TEMPEST_ADMIN] = { _("CULT ADMIN"),50 },
    [TRAINER_CLASS_TEMPEST_LEADER] = { _("CULT LEADER"),100 },
...
static void PlayerTryEvolution(void)
{
    ...
    {
        gLeveledUpInBattle &= ~(1u << LEFT_PKMN);
...
static void HandleEndTurn_BattleWon(void)
{
    ...
    else if (gBattleTypeFlags & BATTLE_TYPE_TRAINER && !(gBattleTypeFlags & BATTLE_TYPE_LINK))
    {
        ...
        case TRAINER_CLASS_TEMPEST_LEADER:
