...
static const u8 sText_OutfitDesc_UnusualRed[] = _(
    "Rather unusual,\nbut still basic\nOUTFIT.");
static const u8 sText_OutfitName_Spark[] = _("TEAM SPARK");
static const u8 sText_OutfitDesc_Spark[] = _(
    "Bright cyan \nuniform with bold, \nsleek design.");
#endif
...
#define OBJ_EVENT_GFX_OUTFIT_RS_BRENDAN_FIELD_MOVE OBJ_EVENT_GFX_BRENDAN_FIELD_MOVE
#define OBJ_EVENT_GFX_OUTFIT_EQUINOX_NORMAL  OBJ_EVENT_GFX_S_EQUINO_M
#define OBJ_EVENT_GFX_OUTFIT_KAEL  OBJ_EVENT_GFX_KAEL
...
const struct Outfit gOutfits[OUTFIT_COUNT] =
{
    ...
    [OUTFIT_USUAL_GREEN] = {
        ...
        .trainerPics = {
            [MALE] =   { TRAINER_PIC_BRENDAN, TRAINER_PIC_BACK_BRENDAN, },
            [FEMALE] = { TRAINER_PIC_MAY, TRAINER_PIC_BACK_MAY, },
        },
    ...
    [OUTFIT_UNUSUAL_RED] = {
        ...
        #endif
        .trainerPics = {
            [MALE]   = {TRAINER_PIC_RS_BRENDAN, TRAINER_PIC_BACK_RUBY_SAPPHIRE_BRENDAN},
            [FEMALE] = {TRAINER_PIC_RS_MAY, TRAINER_PIC_BACK_RUBY_SAPPHIRE_MAY}
        },
        .avatarGfxIds = {
           [MALE] = {
    ...
    [OUTFIT_EQUINOX] = {
        ...
        .prices = { 200, 500 },
        #if MODERN == 1
        .name = COMPOUND_STRING("TEAM SPARK"),
        .desc = COMPOUND_STRING("Bright cyan \nuniform with bold, \nsleek design."),
        #else
        .name = sText_OutfitName_Spark,
        .desc = sText_OutfitDesc_Spark,
        #endif
        .trainerPics = {
            [MALE]   = {TRAINER_PIC_S_EQUINO_GRUNT_M, TRAINER_PIC_BACK_RUBY_SAPPHIRE_BRENDAN},
            [FEMALE] = {TRAINER_PIC_RS_MAY, TRAINER_PIC_BACK_RUBY_SAPPHIRE_MAY}
        },
        .avatarGfxIds = {
           [MALE] = {
               [PLAYER_AVATAR_STATE_NORMAL] =     OBJ_EVENT_GFX_OUTFIT_EQUINOX_NORMAL,
               [PLAYER_AVATAR_STATE_BIKE] =       OBJ_EVENT_GFX_OUTFIT_RS_BRENDAN_ACRO_BIKE,
               [PLAYER_AVATAR_STATE_SURFING] =    OBJ_EVENT_GFX_OUTFIT_RS_BRENDAN_SURFING,
               [PLAYER_AVATAR_STATE_UNDERWATER] = OBJ_EVENT_GFX_OUTFIT_RS_BRENDAN_UNDERWATER
           },
    ...
    [OUTFIT_KAEL] = {
        ...
        #endif
        .trainerPics = {
            [MALE]   = {TRAINER_PIC_KAEL, TRAINER_PIC_BACK_RUBY_SAPPHIRE_BRENDAN},
            [FEMALE] = {TRAINER_PIC_KAEL, TRAINER_PIC_BACK_RUBY_SAPPHIRE_MAY}
        },
        .avatarGfxIds = {
           [MALE] = {
               [PLAYER_AVATAR_STATE_NORMAL] =     OBJ_EVENT_GFX_OUTFIT_KAEL,
               [PLAYER_AVATAR_STATE_BIKE] =       OBJ_EVENT_GFX_OUTFIT_RS_BRENDAN_ACRO_BIKE,
               [PLAYER_AVATAR_STATE_SURFING] =    OBJ_EVENT_GFX_OUTFIT_RS_BRENDAN_SURFING,
               [PLAYER_AVATAR_STATE_UNDERWATER] = OBJ_EVENT_GFX_OUTFIT_RS_BRENDAN_UNDERWATER
           },
