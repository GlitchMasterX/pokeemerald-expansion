...
static const u8 sMapSectionToThemeId[MAPSEC_COUNT - KANTO_MAPSEC_COUNT - 1] =
{
    ...
    [MAPSEC_IRONHEARTH_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_LUXURA_VEILWOOD] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_MT_CINDER] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_LUMINAE_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_VERDANTIA_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ASTRALIS_ACADEMY] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_VOLTHAVEN_CITY] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_SHIMMER_CITY] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_EMBERVALE_CITY] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ASTRAVEIL_CITY] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_NOCTURNE_CITY] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_WILLOWMERE_VILLAGE] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_CINDERBROOK_TOWN] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_FROSTPEAK_VILLAGE] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_LUNAR_GROVE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ASHVEIL_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_THORNVALE_VILLAGE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_MYSTRAL_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_DUSKHOLLOW_VILLAGE] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_SEASIDE_HAVEN] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_WHISPERING_WOODS] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_SHAYMIN_VILLAGE] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_CRYSTALLINE_CAVERNS] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_SCORCHED_WASTES] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_FROSTVEIL_PEAK] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ABYSSAL_TRENCH] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_NETHERVEIL_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_POINT_ALPHA] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_POINT_BETA] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_POINT_GAMMA] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_POINT_DELTA] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_POINT_EPSILON] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_LAKE_SERENITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_REDEMPTION_ISLE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROYAL_CAPITAL] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SILVERPINE_VILLAGE] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_CRYSTALSHORE_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_HIGHPEAK_MONESTERY] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_EMBERWATCH_FORT] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_STARFALL_PLAINS] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_FORGOTTEN_WOODS] = MAPPOPUP_THEME_UNDERWATER,
...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping_BW[] =
{
    ...
    [MAPSEC_IRONHEARTH_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_LUXURA_VEILWOOD] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_MT_CINDER] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_LUMINAE_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_VERDANTIA_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ASTRALIS_ACADEMY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_VOLTHAVEN_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_SHIMMER_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_EMBERVALE_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ASTRAVEIL_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_NOCTURNE_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_WILLOWMERE_VILLAGE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_CINDERBROOK_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_FROSTPEAK_VILLAGE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_LUNAR_GROVE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ASHVEIL_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_THORNVALE_VILLAGE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_MYSTRAL_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_DUSKHOLLOW_VILLAGE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_SEASIDE_HAVEN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_WHISPERING_WOODS] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_SHAYMIN_VILLAGE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_CRYSTALLINE_CAVERNS] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_SCORCHED_WASTES] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_FROSTVEIL_PEAK] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ABYSSAL_TRENCH] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_NETHERVEIL_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_POINT_ALPHA] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_POINT_BETA] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_POINT_GAMMA] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_POINT_DELTA] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_POINT_EPSILON] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_LAKE_SERENITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_REDEMPTION_ISLE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROYAL_CAPITAL] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_SILVERPINE_VILLAGE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_CRYSTALSHORE_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_HIGHPEAK_MONESTERY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_EMBERWATCH_FORT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_STARFALL_PLAINS] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_FORGOTTEN_WOODS] = MAPPOPUP_THEME_BW_DEFAULT,
