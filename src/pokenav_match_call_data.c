...
{
    .type = MC_TYPE_LEADER,
    .mapSec = MAPSEC_ASTRALIS_ACADEMY,
...
static const struct MatchCallLocationOverride sWallyLocationData[] = {
    { FLAG_HIDE_MAUVILLE_CITY_WALLY,          MAPSEC_LUMINAE_CITY },
...
{
    .type = MC_TYPE_LEADER,
    .mapSec = MAPSEC_WILLOWMERE_VILLAGE,
...
{
    .type = MC_TYPE_LEADER,
    .mapSec = MAPSEC_CINDERBROOK_TOWN,
...
{
    .type = MC_TYPE_LEADER,
    .mapSec = MAPSEC_FROSTPEAK_VILLAGE,
