...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_SPARK] = {MAP_GROUP(MAP_DEWFORD_TOWN), MAP_NUM(MAP_DEWFORD_TOWN), HEAL_LOCATION_DEWFORD_TOWN},
    ...
    [MAPSEC_VERDANTURF_TOWN] = {MAP_GROUP(MAP_GRANITE_CAVE_1F), MAP_NUM(MAP_GRANITE_CAVE_1F), HEAL_LOCATION_LUXURA_VEILWOOD},
    [MAPSEC_PACIFIDLOG_TOWN] = {MAP_GROUP(MAP_LUXURA_ISLAND), MAP_NUM(MAP_LUXURA_ISLAND), HEAL_LOCATION_LUXURA_ISLAND},
