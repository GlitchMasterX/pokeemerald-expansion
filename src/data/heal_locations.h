...
{
    [HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE_2F - 1] = {MAP_GROUP(UNDEFINED), MAP_NUM(UNDEFINED), 0, 0},
    [HEAL_LOCATION_LITTLEROOT_TOWN_MAYS_HOUSE_2F - 1] = {MAP_GROUP(UNDEFINED), MAP_NUM(UNDEFINED), 0, 0},
    [HEAL_LOCATION_ASTRALIS_ACADEMY - 1] = {MAP_GROUP(ASTRALIS_ACADEMY), MAP_NUM(ASTRALIS_ACADEMY), 21, 13},
    ...
    [HEAL_LOCATION_PACIFIDLOG_TOWN - 1] = {MAP_GROUP(SLATEPORT_CITY_POKEMON_CENTER_1F), MAP_NUM(SLATEPORT_CITY_POKEMON_CENTER_1F), 8, 16},
    ...
    [HEAL_LOCATION_MEWTWOMET - 1] = {MAP_GROUP(GRANITE_CAVE_1F), MAP_NUM(GRANITE_CAVE_1F), 12, 8},
    [HEAL_LOCATION_NURSEMET - 1] = {MAP_GROUP(LUXURA_ISLAND), MAP_NUM(LUXURA_ISLAND), 33, 18},
};
