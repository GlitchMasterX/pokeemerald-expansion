...
{
    {MAPSEC_THORNVALE_VILLAGE, 2, Landmarks_Route103_2},
    {MAPSEC_MYSTRAL_TOWN, 0, Landmarks_Route104_0},
    {MAPSEC_MYSTRAL_TOWN, 1, Landmarks_Route104_1},
    {MAPSEC_DUSKHOLLOW_VILLAGE, 0, Landmarks_Route105_0},
    {MAPSEC_SEASIDE_HAVEN, 1, Landmarks_Route106_1},
    {MAPSEC_SHAYMIN_VILLAGE, 0, Landmarks_Route108_0},
    {MAPSEC_CRYSTALLINE_CAVERNS, 0, Landmarks_Route109_0},
    {MAPSEC_SCORCHED_WASTES, 0, Landmarks_Route110_0},
    {MAPSEC_SCORCHED_WASTES, 1, Landmarks_Route110_1},
    {MAPSEC_SCORCHED_WASTES, 2, Landmarks_Route110_2},
    {MAPSEC_FROSTVEIL_PEAK, 0, Landmarks_Route111_0},
    {MAPSEC_FROSTVEIL_PEAK, 1, Landmarks_Route111_1},
    {MAPSEC_FROSTVEIL_PEAK, 2, Landmarks_Route111_2},
    {MAPSEC_FROSTVEIL_PEAK, 3, Landmarks_Route111_3},
    {MAPSEC_FROSTVEIL_PEAK, 4, Landmarks_Route111_4},
    {MAPSEC_ABYSSAL_TRENCH, 0, Landmarks_Route112_0},
    {MAPSEC_ABYSSAL_TRENCH, 1, Landmarks_Route112_1},
    {MAPSEC_NETHERVEIL_CITY, 1, Landmarks_Route113_1},
    {MAPSEC_POINT_ALPHA, 1, Landmarks_Route114_1},
    {MAPSEC_POINT_ALPHA, 2, Landmarks_Route114_2},
    {MAPSEC_POINT_ALPHA, 3, Landmarks_MeteorFalls},
    {MAPSEC_POINT_BETA, 0, Landmarks_MeteorFalls},
    {MAPSEC_POINT_BETA, 1, Landmarks_MeteorFalls},
    {MAPSEC_POINT_GAMMA, 1, Landmarks_Route116_1},
    {MAPSEC_POINT_GAMMA, 2, Landmarks_Route116_2},
    {MAPSEC_POINT_DELTA, 2, Landmarks_Route117_2},
    {MAPSEC_LAKE_SERENITY, 1, Landmarks_Route119_1},
    {MAPSEC_REDEMPTION_ISLE, 0, Landmarks_Route120_0},
    {MAPSEC_REDEMPTION_ISLE, 2, Landmarks_Route120_2},
    {MAPSEC_ROYAL_CAPITAL, 2, Landmarks_Route121_2},
    {MAPSEC_SILVERPINE_VILLAGE, 0, Landmarks_Route122_0},
#ifdef BUGFIX
    {MAPSEC_SILVERPINE_VILLAGE, 1, Landmarks_Route122_0},
    {MAPSEC_CRYSTALSHORE_TOWN, 0, Landmarks_Route123_0},
#else
    {MAPSEC_CRYSTALSHORE_TOWN, 0, Landmarks_Route123_0},
    {MAPSEC_SILVERPINE_VILLAGE, 1, Landmarks_Route122_0},
#endif
    {MAPSEC_HIGHPEAK_MONESTERY, 7, Landmarks_Route124_7},
    {MAPSEC_EMBERWATCH_FORT, 2, Landmarks_Route125_2},
